...
ms.service: cosmosdb
---
# Azure CosmosDBManagement client library for JavaScript - version 16.0.0-alpha.20220801.1 
...
[API reference documentation](/javascript/api/@azure/arm-cosmosdb?view=azure-node-preview) |
