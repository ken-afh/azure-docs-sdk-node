...
---
# Azure DynatraceObservability client library for JavaScript - version 1.0.0-alpha.20220729.2 
...
[API reference documentation](/javascript/api/@azure/arm-dynatrace?view=azure-node-preview) |
