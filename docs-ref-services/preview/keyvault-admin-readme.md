...
ms.service: keyvault
---
# Azure Key Vault Administration client library for JavaScript - version 4.2.2-alpha.20220712.2 
...
[docs-overview]: /azure/key-vault/key-vault-overview
...
[storage-account-create-cli]: /azure/storage/common/storage-quickstart-create-account?tabs=azure-cli
[storage-account-create-portal]: /azure/storage/common/storage-quickstart-create-account?tabs=azure-portal
[storage-account-create-ps]: /azure/storage/common/storage-quickstart-create-account?tabs=azure-powershell
