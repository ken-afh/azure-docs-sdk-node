...
ms.service: keyvault
---
# Azure Key Vault Secret client library for JavaScript - version 4.5.0-alpha.20220713.1 
...
- Grant the above mentioned application authorization to perform secret operations on the keyvault:
  ...
  If you have enabled role-based access control (RBAC) for Key Vault instead, you can find roles like "Key Vault Secrets Officer" in our [RBAC guide](/azure/key-vault/general/rbac-guide).
