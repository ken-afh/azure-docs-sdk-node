...
---
# Azure DashboardManagement client library for JavaScript - version 1.0.0-alpha.20220420.2 
...
[API reference documentation](/javascript/api/@azure/arm-dashboard?view=azure-node-preview) |
